        ...
        <div class="col-md-12">
            <div class="p-3 py-4">
                ...
                <table class="table table-bordered table-striped table-hover table-sm">
                    <tr>
                        <th>Tanggal Lahir</th>
                        <td>{{ $user->tanggal_lahir ?? 'Tidak Diketahui' }}</td>
                    </tr>
                    <tr>
                        <th>Jenis Kelamin</th>
                        <td>{{ $user->jenis_kelamin ?? 'Tidak Diketahui' }}</td>
                    </tr>
                    <tr>
                        <th>Alamat</th>
                        <td>{{ $user->alamat ?? 'Tidak Diketahui' }}</td>
                    </tr>
                    <tr>
                        <th>No. Telepon</th>
                        <td>{{ $user->no_telepon ?? 'Tidak Diketahui' }}</td>
                    </tr>
                </table>
            </div>
        </div>
