                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $user->tanggal_lahir ? $user->tanggal_lahir->format('Y-m-d') : '' }}"
                                    type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control">
                                <small id="error-tanggal_lahir" class="error-text form-text text-danger"></small>
                            </div>

                            <div class="form-group">
                                <label>Jenis Kelamin</label>
                                <textarea name="jenis_kelamin" id="jenis_kelamin" class="form-control">{{ $user->jenis_kelamin ?? '' }}</textarea>
                        ...
                        <div class="form-group">
                            <label>Telepon</label>
                            <input value="{{ $user->telepon ?? '' }}" type="text" name="telepon" id="telepon"
                                class="form-control">
