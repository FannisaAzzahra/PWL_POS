    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form method="POST" action="{{ url('transaksi') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-1 control-label col-form-label">Transaksi Tanggal</label>
                    <div class="col-11">
                        <input type="date" class="form-control" id="transaksi_tanggal" name="transaksi_tanggal" value="{{ old('transaksi_tanggal') }}"
                            required>
